...
function agregarPropiedad(objeto, property) {
  ...
  // Devuelve el objeto
  // NOTA: El nombre de la propiedad no es "propiedad", el nombre es el valor del argumento lloamad "property" (una cadena/string)
  // Tu código:
  var i = property;
  objeto[i] = null;
  return objeto;
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  producto["calcularPrecioDescuento"] = function calcularPrecioDescuento(){
   var des = producto["precio"] * producto["porcentajeDeDescuento"];
    var nuevoprecio =  producto["precio"] - des;
    return nuevoprecio;
   };
  return producto;
}
